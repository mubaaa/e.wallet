...
class ExpneseCategory extends StatelessWidget {
  const ExpneseCategory({ Key? key }) : super(key: key);
        ...
        child: Column(
          children: [
            Row(
              ...
              children: [
               const  Text("Categories :",style:TextStyle(color: Colors.white,fontSize: 22),),
                TextButton(onPressed: (){
                  ShowPopupBox(context);
                }, 
                style: TextButton.styleFrom(
                backgroundColor: HexColor("43A79B")),
                child: const Text("ADD",style:TextStyle(color: Colors.white,fontSize: 19),
                ))
              ],
            ),
